...
sudo apt update && sudo apt install vault python3-pip -y
...
echo $secret_result | base64 -d | openssl pkcs12 -clcerts -nokeys -passin pass:${pfx_password} | openssl x509 -out /opt/vault/tls/vault-cert.pem

echo $secret_result | base64 -d | openssl pkcs12 -cacerts -nokeys -chain -passin pass:${pfx_password} | openssl x509 -out /opt/vault/tls/vault-ca.pem

echo $secret_result | base64 -d | openssl pkcs12 -nocerts -nodes -passin pass:${pfx_password} | openssl pkcs8 -nocrypt -out /opt/vault/tls/vault-key.pem
